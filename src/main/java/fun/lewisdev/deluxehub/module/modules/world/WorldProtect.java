...
public class WorldProtect extends Module {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        BuildMode buildMode = ((BuildMode) DeluxeHubPlugin.get().getModuleManager().getModule(ModuleType.BUILD_MODE));
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        BuildMode buildMode = ((BuildMode) DeluxeHubPlugin.get().getModuleManager().getModule(ModuleType.BUILD_MODE));
        if(buildMode.isBuilder(player.getUniqueId()))
            return;
        event.setCancelled(true);
    ...
    public void onEntityDamage(EntityDamageByEntityEvent event) {
        ...
        BuildMode buildMode = ((BuildMode) DeluxeHubPlugin.get().getModuleManager().getModule(ModuleType.BUILD_MODE));
        if(buildMode.isBuilder(event.getDamager().getUniqueId()))
            return;
        event.setCancelled(true);
