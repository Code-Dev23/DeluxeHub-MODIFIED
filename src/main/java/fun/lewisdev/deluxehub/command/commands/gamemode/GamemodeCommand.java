...
public class GamemodeCommand {
    ...
    public void gamemode(final CommandContext args, final CommandSender sender) throws CommandException {
        ...
        if (args.argsLength() == 1) {
            ...
            Messages.GAMEMODE_CHANGE.send(player, "%gamemode%", gamemode.toString().toLowerCase());
            ...
            if (sender.getName().equals(player.getName())) {
                ...
                Messages.GAMEMODE_CHANGE.send(player, "%gamemode%", gamemode.toString().toLowerCase());
                Messages.GAMEMODE_CHANGE_OTHER.send(sender, "%player%", player.getName(), "%gamemode%", gamemode.toString().toLowerCase());
            }
